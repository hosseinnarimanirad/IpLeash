...
public partial class App : Application
{
    ...
    private const string SingleInstanceMutexName = @"Global\Leash.SingleInstance";

    private const string ShowWindowEventName = @"Global\Leash.ShowWindow";
    ...
    private static void SignalRunningInstance()
    {
        ...
        catch (Exception ex) when (ex is WaitHandleCannotBeOpenedException or UnauthorizedAccessException)
        {
            ...
            MessageBox.Show(
                "Leash is already running.\n\nLook for its icon in the notification area.",
                "Leash already running",
                MessageBoxButton.OK,
    ...
    private void UpdateTray(MonitorSnapshot snapshot)
    {
        ...
        _tray.UpdateStatus(snapshot.Status, $"Leash — {state}");
    }

...
{
    private const string AssemblyResourcePrefix = "pack://application:,,,/Leash;component/Assets/";
    ...
    public void Initialize()
    {
        ...
        var open = new Forms.ToolStripMenuItem("Open Leash");
    ...
    {
        _icons[MonitorStatus.Idle] = LoadIcon("leash-idle.ico");
        _icons[MonitorStatus.Allowed] = LoadIcon("leash-allowed.ico");
        _icons[MonitorStatus.Blocked] = LoadIcon("leash-blocked.ico");
        _icons[MonitorStatus.Unknown] = LoadIcon("leash-unknown.ico");
    }
